...
EMSCRIPTEN_SDK_DIR="$HOME/projects/emsdk"
OUT_DIR="build/web"
...
files="$OUT_DIR/game.wasm.o /Users/mawaldne/projects/Odin/vendor/raylib/wasm/libraylib.a /Users/mawaldne/projects/Odin/vendor/raylib/wasm/libraygui.a"

echo $files

# index_template.html contains the javascript code that calls the procedures in source/main_web/main_web.odin
